...
<head>
    ...
    <title>Ubah Siswa | SKANEDA</title>
                ...
                <div class="container-fluid">
                    ...
                    <form action="proses_ubah_siswa.php" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="nis" value="<?php echo $data_siswa['nis']; ?>" class="form-control"
                                required disabled>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="jk" class="form-select" required>
                                <option value="Pria" <?php if ($data_siswa['jk'] == 'Pria')
                                    echo 'selected'; ?>>Pria
                                </option>
                                <option value="Wanita" <?php if ($data_siswa['jk'] == 'Wanita')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="alamat" class="form-control"
                                required><?php echo $data_siswa['alamat']; ?></textarea>
                        </div>
