...
<head>
    ...
    <title>Tambah Mapel | SKANEDA</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="mb-5 text-gray-800">Tambah mapel</h1>

                    <!-- Tambah mapel Form -->
                    <form method="POST" action="proses_tambah_mapel.php">
                        <div class="form-group">
                            <label for="nama_mapel">Nama mapel :</label>
                            <input type="text" class="form-control w-50" id="nama_mapel" name="nama_mapel" required>
                            <label for="jenis_mapel">Jenis Mapel :</label>
                            <input type="text" class="form-control w-50" id="jenis_mapel" name="jenis_mapel" required>
                        </div>
                        <button type="submit" class="btn btn-primary">Tambah mapel</button>
                    </form>
                    <!-- End Tambah mapel Form -->
                </div>
            </div>
